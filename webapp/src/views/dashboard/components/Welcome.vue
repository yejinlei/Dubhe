...
<template>
  <el-card class="welcome" shadow="never">
    ...
    <div class="welcome-desc">天枢一站式 AI 模型开发平台（简称：一站式开发平台）面向 AI 模型生产的生命周期，提供了包括数据处理(数据集管理、智能标注和数据增强)、模型开发、模型训练和模型管理等功能，方便用户一站式构建 AI 算法。</div>
    ...
    <el-row class="card-row">
      <el-col :xs="12" :sm="12" :lg="6" class="card-col">
        <div class="card-panel">
          ...
          <div class="card-panel-desc">为用户提供一站式深度学习开发功能，通过智能数据处理、便利的模型开发和模型训练，打通深度学习全链路。</div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="6" class="card-col">
        <div class="card-panel">
          ...
          <div class="card-panel-desc">除了囊括常规AI算法外，一站式开发平台还集成了多领域的独家算法，提供业界领先性能。</div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="6" class="card-col">
        <div class="card-panel">
          ...
          <div class="card-panel-desc">除了一站式深度学习开发平台，亦提供可视化和动静结合编码方式，调试灵活，小白亦可快速上手。</div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="6" class="card-col">
        <div class="card-panel">
          ...
          <div class="card-panel-desc">集成自主研发的分布式训练平台，提供高性能的分布式计算体验，节省训练成本和训练时间。</div>
        </div>
      </el-col>
    </el-row>
  </el-card>

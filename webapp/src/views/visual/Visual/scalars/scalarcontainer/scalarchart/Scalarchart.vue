...
export default {
  ...
  methods: {
    ...
    SvgDraw() {
      ...
      // Add X axis
      const xdomain = d3.extent(data, function my1(d) { return d.step; });
      ...
      // Add Y axis
      const ydomain = d3.extent(data, function my2(d) { return d.value; });
      ...
      line.append('path')
        ...
        .attr('d', d3.line()
          .x(function my3(d) { return x(d.step); })
          .y(function my4(d) { return y(d.value); }),
        );
      // Add the smooth line
      line.append('path')
        .datum(smoothdata)
        ...
        .attr('stroke-width', 1.5)
        .attr('d', d3.line()
          .x(function my5(d) { return x(d.step); })
          .y(function my6(d) { return y(d.value); }),
        );
      // Add the brushing
      line
        .append('g')
      ...
      line
        ...
        .append('circle')
        .attr('class', 'myCircle')
        .attr('cx', function my7(d) { return x(d.step); })
        .attr('cy', function my8(d) { return y(d.value); })
        .attr('r', 3)
      ...
      function updateChart() {
        ...
        line
          ...
          .duration(1000)
          .attr('d', d3.line()
            .x(function my81(d) { return x(d.step); })
            .y(function my82(d) { return y(d.value); }),
          );
        line
          .select('.originalline')
          .transition()
          .duration(1000)
          .attr('d', d3.line()
            .x(function my83(d) { return x(d.step); })
            .y(function my84(d) { return y(d.value); }),
          );
        line
          .selectAll('.myCircle')
          .transition()
          .duration(1000)
          .attr('cx', function my85(d) { return x(d.step); })
          .attr('cy', function my86(d) { return y(d.value); });
      }
      ...
      svg.on('dblclick', function my12() {
        ...
        line
          ...
          .duration(1000)
          .attr('d', d3.line()
            .x(function my13(d) { return x(d.step); })
            .y(function my14(d) { return y(d.value); }),
          );
        line
          ...
          .duration(1000)
          .attr('d', d3.line()
            .x(function my15(d) { return x(d.step); })
            .y(function my16(d) { return y(d.value); }),
          );
        line
          .selectAll('.myCircle')
          .transition()
          .duration(1000)
          .attr('cx', function my17(d) { return x(d.step); })
          .attr('cy', function my18(d) { return y(d.value); });
      });
    },
    MergeSvgDraw() {
      ...
      // color palette
      const res = data.map(function my19(d) { return d.order; }); // list of group names
      ...
      // Add X axis
      const xdomain = d3.extent(dataset0, function my20(d) { return d.step; });
      const xgap = xdomain[1] - xdomain[0];
      xdomain[0] -= xgap / 4;
      xdomain[1] += xgap / 4;
      const x = d3.scaleLinear()
      ...
      // Add Y axis
      const ydomain = d3.extent(dataset0, function my21(d) { return d.value; });
      const ygap = ydomain[1] - ydomain[0];
      ydomain[0] -= ygap / 4;
      ydomain[1] += ygap / 4;
      const y = d3.scaleLinear()
      ...
      line.selectAll('.smoothline')
        ...
        .attr('class', 'smoothline')
        .attr('fill', 'none')
        .attr('stroke', function my22(d) { return color(d.order); })
        .attr('stroke-width', 1.5)
        .attr('d', function my23(d) {
          return d3.line()
            .x(function my24(d) { return x(d.step); })
            .y(function my25(d) { return y(d.value); })(d.value);
        });
      // Add the brushing
      line
        .append('g')
      ...
      line
        ...
        .append('circle')
        .attr('class', 'myCircle')
        .attr('cx', function my26(d) { return x(d.step); })
        .attr('cy', function my27(d) { return y(d.value); })
        .attr('r', 3)
        .attr('stroke', 'black')
        .attr('stroke-width', 10)
        .attr('fill', 'black')
      ...
      legend.append('text')
        ...
        .text(function my33(d) { return `${d.run  },${  d.tag}`; });
      // A function that set idleTimeOut to null
      let idleTimeout;
      function idled() { idleTimeout = null; }
      ...
      function updateChart() {
        ...
        line
          ...
          .attr('d', function my87(d) {
            return d3.line()
              .x(function my88(d) { return x(d.step); })
              .y(function my89(d) { return y(d.value); })(d.value);
          });
        line
          .selectAll('.myCircle')
          .transition()
          .duration(1000)
          .attr('cx', function my90(d) { return x(d.step); })
          .attr('cy', function my91(d) { return y(d.value); });
      }
      brush.on('end', updateChart);
      // If user double click, reinitialize the chart
      svg.on('dblclick', function my34() {
        ...
        line
          ...
          .attr('d', function my35(d) {
            return d3.line()
              .x(function my36(d) { return x(d.step); })
              .y(function my37(d) { return y(d.value); })(d.value);
          });
        line
          .selectAll('.myCircle')
          .transition()
          .duration(1000)
          .attr('cx', function my38(d) { return x(d.step); })
          .attr('cy', function my39(d) { return y(d.value); });
      });
    },
    DYMergeSvgDraw() {
      const {legendnumber} = this;
      ...
      // color palette
      const res0 = data0.map(function my40(d) { return d.order; }); // list of group names
      const color0 = d3.scaleOrdinal()
        .domain(res0)
        .range(['#ed357b', '#1d276e', '#6ec6d0', '#0c9257', '#ffdf1e', '#fe8325']);
      const res1 = data1.map(function my41(d) { return d.order; }); // list of group names
      ...
      // Add X axis
      const xdomain0 = d3.extent(dataset00, function my42(d) { return d.step; });
      const xdomain1 = d3.extent(dataset11, function my43(d) { return d.step; });
      const xdomain = [];
      ...
      // Add Y0 axis
      const ydomain0 = d3.extent(dataset00, function my44(d) { return d.value; });
      ...
      // Add Y1 axis
      const ydomain1 = d3.extent(dataset11, function my45(d) { return d.value; });
      ...
      line.selectAll('.smoothline0')
        ...
        .attr('fill', 'none')
        .attr('stroke', function my46(d) { return color0(d.order); })
        .attr('stroke-width', 1.5)
        .attr('d', function my47(d) {
          return d3.line()
            .x(function my48(d) { return x(d.step); })
            .y(function my49(d) { return y0(d.value); })(d.value);
        });
      line.selectAll('.smoothline1')
        ...
        .attr('fill', 'none')
        .attr('stroke', function my50(d) { return color1(d.order); })
        .attr('stroke-width', 1.5)
        .attr('d', function my51(d) {
          return d3.line()
            .x(function my52(d) { return x(d.step); })
            .y(function my53(d) { return y1(d.value); })(d.value);
        });
      // Add the brushing
      line
        .append('g')
      ...
      line
        ...
        .attr('cx', function my54(d) { return x(d.step); })
        .attr('cy', function my55(d) { return y0(d.value); })
        .attr('r', 3)
        .attr('stroke', 'black')
        .attr('stroke-width', 10)
        .attr('fill', 'black')
      ...
      line
        ...
        .attr('cx', function my59(d) { return x(d.step); })
        .attr('cy', function my60(d) { return y1(d.value); })
        .attr('r', 3)
        .attr('stroke', 'black')
        .attr('stroke-width', 10)
        .attr('fill', 'black')
      ...
      // add the legend0
      const legend0 = svg.selectAll('.legend0')
        .data(smoothdata0)
        .enter()
        .append('g')
        .attr('class', 'legend0')
      ...
      legend0.append('text')
        ...
        .attr('font-size', '10px')
        .style('text-anchor', 'start')
        .text(function my66(d) { return `${d.run  },${  d.tag}`; });
      // add the legend0
      const legend1 = svg.selectAll('.legend1')
        .data(smoothdata1)
        .enter()
        .append('g')
        .attr('class', 'legend1')
      ...
      legend1.append('text')
        ...
        .attr('font-size', '10px')
        .style('text-anchor', 'start')
        .text(function my69(d) { return `${d.run  },${  d.tag}`; });
      // A function that set idleTimeOut to null
      let idleTimeout;
      function idled() { idleTimeout = null; }
      ...
      function updateChart() {
        ...
        line
          ...
          .attr('d', function my92(d) {
            return d3.line()
              .x(function my93(d) { return x(d.step); })
              .y(function my94(d) { return y0(d.value); })(d.value);
          });
        line
          ...
          .attr('d', function my95(d) {
            return d3.line()
              .x(function my96(d) { return x(d.step); })
              .y(function my97(d) { return y1(d.value); })(d.value);
          });
        line
          .selectAll('.myCircle0')
          .transition()
          .duration(1000)
          .attr('cx', function my98(d) { return x(d.step); })
          .attr('cy', function my99(d) { return y0(d.value); });
        line
          .selectAll('.myCircle1')
          .transition()
          .duration(1000)
          .attr('cx', function my100(d) { return x(d.step); })
          .attr('cy', function my101(d) { return y1(d.value); });
      }
      brush.on('end', updateChart);
      // If user double click, reinitialize the chart
      svg.on('dblclick', function my70() {
        ...
        line
          ...
          .attr('d', function my71(d) {
            return d3.line()
              .x(function my72(d) { return x(d.step); })
              .y(function my73(d) { return y0(d.value); })(d.value);
          });
        line
          .selectAll('.myCircle0')
          .transition()
          .duration(1000)
          .attr('cx', function my74(d) { return x(d.step); })
          .attr('cy', function my75(d) { return y0(d.value); });
        line
          .selectAll('.smoothline1')
          .transition()
          .duration(1000)
          .attr('d', function my76(d) {
            return d3.line()
              .x(function my77(d) { return x(d.step); })
              .y(function my78(d) { return y1(d.value); })(d.value);
          });
        line
          .selectAll('.myCircle1')
          .transition()
          .duration(1000)
          .attr('cx', function my79(d) { return x(d.step); })
          .attr('cy', function my80(d) { return y1(d.value); });
      });
    },
  },
};

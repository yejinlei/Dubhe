...
<template>
  ...
  <div class="temp">
            ...
            <template v-for="(item1,index1) in item">
              ...
              <el-row :key="index1+'mainSection'" class="mainSection">
                ...
                <template v-for="(item2,index2) in item1">
                  ...
                  <div :key="index1+'-'+index2+'-section'" style=" margin-right: 2%; margin-left: 4%;">
    ...
    <div class="buttons">
      <el-tooltip class="item" effect="dark" content="条件过滤后点击该按钮隐藏节点" placement="top-start">
      ...
      <el-card>
        <div class="infoContent">
          <template v-for="(item3,index) in obj">
            <div :key="index+'-control'" class="information" style="float: left; width: 100%; clear: both;">

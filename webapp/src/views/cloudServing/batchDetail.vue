...
import { parseTime, downloadZipFromObjectPath, RESOURCES_POOL_TYPE_MAP } from '@/utils';
import { SERVING_STATUS_ENUM, BATCH_SERVING_STATUS_MAP, generateMap, batchServingProgressColor } from './util';
...
export default {
  ...
  methods: {
    ...
    doDownload() {
      ...
      downloadZipFromObjectPath(this.item.outputPath, `${this.item.name}-result.zip`, { flat: true });

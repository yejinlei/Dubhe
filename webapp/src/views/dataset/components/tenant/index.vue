...
<template>
  <el-dropdown trigger="click" placement="bottom-start" @command="onCommand">
    ...
    <el-dropdown-menu slot="dropdown">
      <el-dropdown-item command="0" :disabled="state.datasetListType === '0'" :style="choosed('0')">视觉/文本</el-dropdown-item>
      <el-dropdown-item command="1" :disabled="state.datasetListType === '1'" :style="choosed('1')">医学影像</el-dropdown-item>
    </el-dropdown-menu>
  </el-dropdown>
</template>

...
<template>
  <div class='dwv-content'>
    <p>欢迎使用天枢医疗影像标注工具！</p>
    <p>在这里，你可以通过上传标准 <el-link href="https://www.dicomstandard.org/" target="_blank">DICOM</el-link> 文件就能实现随时随地进行医疗影像查询、阅片、智能识别、影像标注等常见操作。系统还提供了一些标准工具对影像文件进行操作，包括滚动浏览，缩放/拖拽，窗宽/窗位，对比，预设窗口等工具。</p>
    ...
    <el-collapse v-model="activeNames" accordion>
      ...
      <el-collapse-item title="绘制标注（Draw）" name="Draw">
        <div>基于锚点绘制标注</div>
        <div>绘制标注：按下鼠标开始绘制锚点，移动鼠标到想要的地点，再次单击鼠标连接两个锚点，双击完成绘制。</div>
        <div>修改标注：单击选中标注路径，路径出现锚点，拖动锚点到想要的位置，点击「保存」按钮完成修改</div>

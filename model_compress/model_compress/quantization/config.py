...
def get_parser(parser=None):
    ...
    parser.add_argument("--model", type=str, default="resnet50",
                        help="resnet50")
    parser.add_argument('--use_fp16', type=str2bool, nargs='?', const=False, default=False, help='Whether to use use fp16')
    parser.add_argument('--use_xla', type=str2bool, nargs='?', const=False, default=False, help='Whether to use xla')
    parser.add_argument('--use_tensorrt', type=str2bool, nargs='?', default=False, help='Whether to use tensorrt')
    parser.add_argument('--use_int8_online', type=str2bool, nargs='?', default=False,
                        help='Whether to use online int8 calibration')
    parser.add_argument('--use_int8_offline', type=str2bool, nargs='?', default=False,
                        help='Whether to use online int8 calibration')

    parser.add_argument('--channel_last', type=str2bool, nargs='?', const=False, default=False,
                        help='Whether to use use channel last mode(nhwc)')
    parser.add_argument('--pad_output', type=str2bool, nargs='?', const=True,
                        help='Whether to pad the output to number of image channels to 4.')

    # train and validaion
    parser.add_argument('--num_epochs', type=int,
                        default=10, help='number of epochs')
    parser.add_argument("--model_load_dir", type=str, default="./model/resnet50",
                        help="model load directory if need")
    parser.add_argument("--model_dir", type=str, default=None, help="model load directory if need")
    parser.add_argument("--dataset_dir", type=str, default=None, help="dataset load directory if need")
    ...
    parser.add_argument('--fuse_bn_relu', type=str2bool, default=False,
                        help='Whether to use use fuse batch normalization relu. Currently supported in origin/master of OneFlow only.'
                        )
    parser.add_argument('--fuse_bn_add_relu', type=str2bool, default=False,
    ...
    # inference
    parser.add_argument("--image_path", type=str, default='/usr/local/test_img/tiger.jpg', help="image path")

    # for data process
    parser.add_argument("--num_classes", type=int, default=1000, help="num of pic classes")
    parser.add_argument("--num_examples", type=int,
                        default=50, help="train pic number")
    ...
    parser.add_argument("--result_dir", type=str, default="./result", help="the save directory of results")

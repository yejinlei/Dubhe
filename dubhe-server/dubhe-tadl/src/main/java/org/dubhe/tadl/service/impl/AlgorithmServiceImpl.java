...
public class AlgorithmServiceImpl extends ServiceImpl<AlgorithmMapper, Algorithm> implements AlgorithmService {
    ...
    public AlgorithmNextVersionVO getNextVersionName(Long algorithmId) {
        ...
        // 当前版本信息
        if (!StringUtils.isBlank(algorithmVersionService.selectById(algorithm.getAlgorithmVersionId()).getVersionName())) {
    ...
    public void doPublish(AlgorithmVersionCreateDTO algorithmVersionCreateDTO){
        ...
        // 写版本表
        AlgorithmVersion algorithmVersion = algorithmVersionService.selectById(algorithm.getAlgorithmVersionId());
    ...
    public void versionSwitch(Long algorithmId, Long algorithmVersionId) {
        ...
        AlgorithmVersion algorithmVersion = algorithmVersionService.selectById(algorithmVersionId);
    ...
    public void update(AlgorithmUpdateDTO algorithmUpdateDTO) {
        // 校验是否是最新版本
        AlgorithmVersion algorithmVersionCheck = algorithmVersionService.selectById(algorithmUpdateDTO.getAlgorithmVersionId());
    ...
    public void delete(AlgorithmVersionDeleteDTO algorithmVersionDeleteDTO) {
        Algorithm algorithm = baseMapper.selectById(algorithmVersionDeleteDTO.getAlgorithmId());
        ...
        AlgorithmVersion algorithmVersion = algorithmVersionService.selectById(algorithmVersionDeleteDTO.getAlgorithmVersionId());

...
public abstract class AbstractExperimentStageState {
    ...
    public Long getRunTime(ExperimentStage experimentStage){
        long beginTime = Objects.isNull(experimentStage.getBeginTime())? MagicNumConstant.ZERO_LONG :experimentStage.getBeginTime().getTime();
        return System.currentTimeMillis() - beginTime + experimentStage.getRunTime();
    }

...
public class ExperimentStageVO implements Serializable {
    ...
    public static ExperimentStageVO from(ExperimentStage experimentStage, String yaml, AlgorithmStage algorithmStage){
        ...
        experimentStageVO.setGpuModel(experimentStage.getGpuModel());
        experimentStageVO.setGpuType(experimentStage.getGpuType());
        experimentStageVO.setK8sLabelKey(experimentStage.getK8sLabelKey());

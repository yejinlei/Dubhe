...
@Component
public class FinishedExperimentStageState extends AbstractExperimentStageState {

    @Override
    public String currentStatus() {
        return ExperimentStageStateEnum.FINISHED_EXPERIMENT_STAGE_STATE.getDescription();
    }
}

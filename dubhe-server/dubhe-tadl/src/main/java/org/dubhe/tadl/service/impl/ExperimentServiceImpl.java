...
public class ExperimentServiceImpl extends ServiceImpl<ExperimentMapper, Experiment> implements ExperimentService {
    ...
    public ExperimentVO info(Long experimentId) {
        ...
        AlgorithmVersion algorithmVersion = algorithmVersionService.selectById(experiment.getAlgorithmVersionId());
        ...
        experimentVO.setStage(experimentStages.stream().map(stage -> {
            ...
            AlgorithmStage algorithmStage = algorithmStageService.getOneById(stage.getAlgorithmStageId());
    ...
    public void update(ExperimentUpdateDTO experimentUpdateDTO) {
        ...
        //获取算法对象
        Algorithm algorithm = algorithmService.getOneById(experimentUpdateDTO.getAlgorithmId());
        // 更新实验
    ...
    public void create(ExperimentCreateDTO experimentCreateDTO) {
        ...
        //获取算法对象
        Algorithm algorithm = algorithmService.getOneById(experimentCreateDTO.getAlgorithmId());
        // 写实验表
    ...
    public ExperimentAndTrailDTO buildExperimentStageQueueMessage(Long experimentId, ExperimentStage experimentStage) {
        ...
        //算法获取
        Algorithm algorithm = algorithmService.getOneById(baseMapper.selectById(experimentId).getAlgorithmId());
    ...
    private List<TrialRunParamDTO> setRunParamData(ExperimentStage stage, AlgorithmStage algorithmStage, Algorithm algorithm, Experiment experiment, List<Trial> trials) {
        ...
        trials.forEach(trial -> {
            ...
            // 节点类型(0为CPU，1为GPU)
            trialRunParamDTO.setResourcesPoolType(resource.getResourcesPoolType() ? NumberConstant.NUMBER_1 : NumberConstant.NUMBER_0);
            ...
            //
            trialRunParamDTO.setGpuType(stage.getGpuType());
            trialRunParamDTO.setGpuModel(stage.getGpuModel());
            trialRunParamDTO.setK8sLabelKey(stage.getK8sLabelKey());
            //组装启动命令
            try {

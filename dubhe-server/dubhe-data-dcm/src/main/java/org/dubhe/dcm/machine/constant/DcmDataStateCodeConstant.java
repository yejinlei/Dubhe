 ...
 * @date 2020-09-03
 */
public class DcmDataStateCodeConstant {

    private DcmDataStateCodeConstant() {
    }
     ...
     * 标注中
     */
    public static final Integer ANNOTATION_DATA_STATE = 102;
    /**
     * 自动标注中
     */
     ...
     * 自动标注完成
     */
    public static final Integer AUTO_ANNOTATION_COMPLETE_STATE = 104;
    /**
     * 标注完成
     */

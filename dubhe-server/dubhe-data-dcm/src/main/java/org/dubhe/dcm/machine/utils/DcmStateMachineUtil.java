...
import org.dubhe.dcm.machine.proxy.DcmStateMachineProxy;
 ...
 * @date 2020-08-27
 */
public class DcmStateMachineUtil {
    ...
    public static void stateChange(StateChangeDTO stateChangeDTO) {
        DcmStateMachineProxy.proxyExecutionSingleState(stateChangeDTO);
    }
    ...
    public static void stateChange(List<StateChangeDTO> stateChangeDTOList) {
        DcmStateMachineProxy.proxyExecutionRelationState(stateChangeDTOList);
    }

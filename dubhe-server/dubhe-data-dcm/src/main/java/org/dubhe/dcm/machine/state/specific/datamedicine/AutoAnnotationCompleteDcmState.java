...
/**
 * @description 自动标注完成状态类
 * @date 2020-08-27
 */
@Component
public class AutoAnnotationCompleteDcmState extends AbstractDataMedicineState {
    ...
    public void annotationSaveEvent(DataMedicine medical) {
        LogUtil.debug(LogEnum.STATE_MACHINE, " 【自动标注完成】 执行事件前内存中状态机的状态 :{} ", dcmDataMedicineStateMachine.getMemoryDataMedicineState());

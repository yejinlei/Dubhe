...
/**
 * @description 资源规格管理远程调用熔断类
 * @date 2021-06-02
 */
public class ResourceSpecsClientFallback implements ResourceSpecsClient {

    @Override
    public DataResponseBody<QueryResourceSpecsVO> queryResourceSpecs(QueryResourceSpecsDTO queryResourceSpecsDTO) {
        return DataResponseFactory.failed("call admin server queryResourceSpecs error");
    }
}
...
import org.dubhe.train.client.fallback.NoteBookClientFallback;
...
public interface NoteBookClient {
     ...
     *
     * @param id
     * @return NoteBookVO notebook详情
     */
    @GetMapping("/notebooks/detail/{id}")
    DataResponseBody<NoteBookVO> getNoteBook(@PathVariable("id") Long id);

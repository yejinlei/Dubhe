...
package org.dubhe.k8s.event.watcher;
...
import org.dubhe.k8s.event.callback.DeploymentCallback;
...
public class DeploymentWatcher implements CommandLineRunner, Watcher<Deployment> {
    ...
    public void run(String... args) {
        ...
        try {
            ...
            LogUtil.error(LogEnum.BIZ_K8S, "DeploymentWatcher init failed, error {}", e.getMessage());
        }

...
public class TerminalApiImpl implements TerminalApi {
    ...
    public TerminalResourceVO create(TerminalBO bo) {
        try {
            LogUtil.info(LogEnum.BIZ_K8S, "Params of creating TerminalApiImpl--create:{}", JSON.toJSONString(bo));
            BaseResourceBo baseResourceBo = new BaseResourceBo();
            BeanUtils.copyProperties(bo, baseResourceBo);
            baseResourceBo.setName(bo.getResourceName());
            //资源配额校验
            ...
            if (!LimitsOfResourcesEnum.ADEQUATE.equals(limitsOfResources)) {
                LogUtil.info(LogEnum.BIZ_K8S, "TerminalApiImpl--limitsOfResources:{}", limitsOfResources.getMessage());
            ...
            if (!LackOfResourcesEnum.ADEQUATE.equals(lack)) {
                LogUtil.info(LogEnum.BIZ_K8S, "TerminalApiImpl--lack:{}", lack.getMessage());
            ...
            bo.setCustomResourcesLimitsMap(k8sCommonUtils.getRdmaResource());

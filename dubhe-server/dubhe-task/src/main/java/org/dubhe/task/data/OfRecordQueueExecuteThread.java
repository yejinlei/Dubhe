...
public class OfRecordQueueExecuteThread implements Runnable {
     ...
     * ofRecord任务处理
     *
     * @param object ofRecord转换详情
     */
    @Transactional(rollbackFor = Exception.class)
    public void execute(Object object) {
        LogUtil.info(LogEnum.BIZ_DATASET, object.toString());
        OfRecordTaskDto ofRecordTaskDto = JSON.parseObject(JSON.toJSONString(redisUtils.get(object.toString())), OfRecordTaskDto.class);

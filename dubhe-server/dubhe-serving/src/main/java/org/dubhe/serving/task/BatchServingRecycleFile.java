...
/**
 * @description serving批量服务文件资源回收/还原
 * @date 2021-04-07
 */
@RefreshScope
@Component(value = "batchServingRecycleFile")
public class BatchServingRecycleFile extends AbstractGlobalRecycle {
    ...
    protected void rollback(RecycleCreateDTO dto) {
        batchServingService.recycleRollback(dto);
    }
}

...
/**
 * @description 云端Serving：在线服务管理远程调用熔断类
 * @date 2021-03-09
 */
public class ServingClientFallback implements ServingClient {
    @Override
    public DataResponseBody<Boolean> getServingModelStatus(PtModelStatusQueryDTO ptModelStatusQueryDTO) {
        return DataResponseFactory.failed("call dubhe-serving server ServingClient:getServingModelStatus error");
    }
}
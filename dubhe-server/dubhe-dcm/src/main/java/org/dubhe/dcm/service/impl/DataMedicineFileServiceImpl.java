...
public class DataMedicineFileServiceImpl extends ServiceImpl<DataMedicineFileMapper, DataMedicineFile> implements DataMedicineFileService {
     ...
     */
    @Override
    public List<String> listMedicineFilesUrls(Long medicineId) {
        return baseMapper.listMedicineFilesUrls(medicineId);
    }
    ...
    public void delete(Long id) {
        baseMapper.deleteMedicineFile(id);
    }
    ...
    public void updateUserIdByMedicineId(Long medicineId) {
        baseMapper.updateUserIdByMedicineId(medicineId,JwtUtils.getCurrentUserDto().getId());
    }

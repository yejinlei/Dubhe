...
package org.dubhe.notebook.domain.vo;
...
public class NoteBookVO implements Serializable {
    ...
    @ApiModelProperty("内存大小（M）")
    private Integer memNum;

    @ApiModelProperty("硬盘内存大小（M）")
    ...
    @JsonFormat(pattern = DatePattern.NORM_DATETIME_MS_PATTERN, timezone = DateUtil.DEFAULT_TIME_ZONE)
    private Date createTime;

    @JsonIgnore
    private Long createUserId;

    @ApiModelProperty("资源创建者用户名")

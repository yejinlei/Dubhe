...
import org.dubhe.service.abstracts.AbstractDeploymentCallback;
...
public class ServingAsyncServiceImpl extends AbstractDeploymentCallback implements DeploymentCallbackAsyncService {
    ...
    public <R extends BaseK8sDeploymentCallbackCreateDTO> boolean doCallback(int times, R k8sDeploymentCallbackCreateDTO) {
        ...
        //在线服务回调
        return servingService.servingCallback(times, req);
    }
